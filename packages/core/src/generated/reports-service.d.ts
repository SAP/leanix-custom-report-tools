...
export interface components {
    schemas: {
        ...
        CustomReportVersionMetadataDto: {
             ...
             * @enum {string}
             */
            status: "SCANNING" | "BUILDING" | "READY" | "VULNERABLE" | "REVOKED" | "FAILED";
            /**
             * Format: date-time
            ...
            /** @example null */
            securityScan: components["schemas"]["CustomReportVersionMetadataDtoSecurityScan"] | null;
        };
        ScanCallbackBody: {
            vulnerable: boolean;
            blackduck: {
        ...
        CustomReportResponseDto__schema0: (string | number | boolean | components["schemas"]["CustomReportResponseDto__schema0"][] | {
            [key: string]: components["schemas"]["CustomReportResponseDto__schema0"];
        }) | null;
